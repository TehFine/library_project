          ...
          <Card padding="none" className="overflow-hidden border-none shadow-card">
            {!isFiltered ? (
              ...
              <>
                ...
                <table className="w-full text-left min-w-[700px]"><thead className="bg-slate-50 text-[10px] font-bold text-slate-400 uppercase tracking-widest border-b border-slate-100">
                    <tr>
